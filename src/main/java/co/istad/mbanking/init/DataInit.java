...
public class DataInit {
    ...
    void initRole() {
        if (roleRepository.count() < 1) {
            ...
            Role user = new Role();
            user.setName("USER");
            user.setAuthorities(List.of(userRead, accountRead, transactionRead, accountTypeRead));


            Role admin = new Role();
            admin.setName("ADMIN");
            admin.setAuthorities(List.of(userWrite, accountTypeWrite, accountWrite));
            ...
            customer.setAuthorities(List.of(userWrite, transactionWrite, accountWrite));
